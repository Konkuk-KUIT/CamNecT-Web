...
export const TypingArea = ({ onSend }: TypingAreaProps) => {
    ...
    return (
        <>
            <div className="flex justify-center fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white px-[25px] pt-[6px] pb-[calc(25px+env(safe-area-inset-bottom, 0px))] z-50">
