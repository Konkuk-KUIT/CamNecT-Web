...
export const MyBookmarksPage = () => {
    ...
    const filteredInternalActivityPosts = sortPosts(MOCK_INTERNAL_ACTIVITY_POSTS);
    const filteredExternalActivityPosts = sortPosts(MOCK_EXTERNAL_ACTIVITY_POSTS);
    const filteredRecruitPosts = sortPosts(MOCK_RECRUIT_POSTS);
