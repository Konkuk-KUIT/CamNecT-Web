...
import {
    getMyBookmarksCommunity,
    getMyBookmarksExternal,
    getMyBookmarksRecruitment,
...
export const MyBookmarksPage = () => {
    ...
    const [sortOrder, setSortOrder] = useState<SortType>('recommended');
    ...
    const {
        ...
        queryKey: ["myBookmarks", "community", userId, sort],
        queryFn: ({ pageParam }) => getMyBookmarksCommunity({
            userId: userId!,
            sort,
    ...
    const {
        ...
        queryKey: ["myBookmarks", "external", userId, sort],
        queryFn: ({ pageParam }) => getMyBookmarksExternal({
            userId: userId!,
            sort,
            cursorId: pageParam?.cursorId,
            cursorValue: pageParam?.cursorValue,
    ...
    const {
        ...
        queryKey: ["myBookmarks", "recruitment", userId, sort],
        queryFn: ({ pageParam }) => getMyBookmarksRecruitment({
            userId: userId!,
            sort,
            cursorId: pageParam?.cursorId,
            cursorValue: pageParam?.cursorValue,
