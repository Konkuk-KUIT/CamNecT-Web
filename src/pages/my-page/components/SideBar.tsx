...
export const SideBar = ({ isOpen, onClose, user }: SideBarProps) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div className="fixed top-0 left-0 h-full w-5/6 bg-white z-50 shadow-lg">
                <div className="flex flex-col px-[25px] pt-[68px]">
                    {/* Header Section */}
                    ...
                    {/* Menu Section */}
                    <div className="flex flex-col gap-[30px] flex-1 pt-[40px]">
                        {/* 나의 활동 */}
